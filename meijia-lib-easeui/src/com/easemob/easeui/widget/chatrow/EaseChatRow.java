...
//            UserUtils.setUserNick(EMChatManager.getInstance().getCurrentUser(), usernickView);
          //设置昵称和头像 by garry
            EaseUserUtils.setUserAvatarAndNick(context, EMChatManager.getInstance().getCurrentUser(), userAvatarView, null);
        }else{
            EaseUserUtils.setUserAvatar(context, message.getFrom(), userAvatarView);
            EaseUserUtils.setUserNick(message.getFrom(), usernickView);
          //设置昵称和头像 by garry
            EaseUserUtils.setUserAvatarAndNick(context, message.getFrom(), userAvatarView, usernickView);
        }
