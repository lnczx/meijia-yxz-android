...
import com.simi.easemob.EMDemoModel;
 ...
 * 
 */
public class EMSettingsFragment extends Fragment implements OnClickListener {
    ...
    private EMDemoModel settingsModel;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		settingsModel = EMDemoHelper.getInstance().getModel();
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if(((EMMainActivity)getActivity()).isConflict){
        	...
        	outState.putBoolean(EMConstant.ACCOUNT_REMOVED, true);
        }
    }
}
