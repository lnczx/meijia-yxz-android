...
import com.meijialife.simi.photo.util.BitmapCache;
import com.meijialife.simi.photo.util.BitmapCache.ImageCallback;
...
//			Res.getLayoutID("plugin_camera_select_imageview")
			convertView = LayoutInflater.from(mContext).inflate(R.layout.plugin_camera_select_imageview
					, parent, false);
