...
public class MainPlusActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        v = getLayoutInflater().inflate(R.layout.layout_find, null);
        initView();
    }
    ...
    private void initView() {
        ...
        setClick();
        user = DBHelper.getUser(MainPlusActivity.this);
        if (user != null) {
            getAppHelp();
            getFindPlusIcon();
        } else {
    ...
    private void popWindow(final AppHelpData appHelpData) {
        View view = getLayoutInflater().inflate(R.layout.layout_tip_activity, null);
