 ...
 * 
 */
public class MainPlusMorningActivity extends BaseActivity implements OnClickListener, ItemScroListener  {
                ...
                if (on) {
                    if (StringUtils.isEquals(is_senior, "1")) {// 有秘书
                        if (chooseDate == null) {
                            ...
                            UIUtils.showToast(MainPlusMorningActivity.this, "请选择时间");
                            return;
                        }
                        ...
                        //选择时间不对的情况走else
                            ...
                            UIUtils.showActionDialog(MainPlusMorningActivity.this, "提醒", "秘书工作时间为7:00～19:00，请在此时间内设置秘书提醒时间，0:01—15:00可以设置当天11:00之后的提醒；15:01至0:00可以设置次日7:00之后的提醒。","确定", null, null, null);
                        }
                        ...
                        SET_SEC_DO = NO_SEC_DO;
                        tv_senser_tip.setVisibility(View.GONE);
                        startActivity(new Intent(MainPlusMorningActivity.this, FindSecretaryActivity.class));
                        Toast.makeText(MainPlusMorningActivity.this, "你没有购买秘书卡", Toast.LENGTH_SHORT).show();
                    }
                }else{
                    tv_senser_tip.setVisibility(View.GONE);
                }
    ...
    public void onClick(View v) {
        ...
        case R.id.layout_select_phonenumber:// 选择通讯录
            Intent intent = new Intent(MainPlusMorningActivity.this, ContactChooseActivity.class);
            startActivityForResult(intent, GET_CONTACT);

            break;
        case R.id.layout_meeting_content:
            Intent intent2 = new Intent(MainPlusMorningActivity.this, MainPlusContentActivity.class);
            intent2.putExtra(Constants.MAIN_PLUS_FLAG, Constants.MORNING);
        ...
        case R.id.layout_select_who:
            Intent mintent = new Intent(MainPlusMorningActivity.this, CreateForWhoActivity.class);
...
//              if (mYear < year || mMonth < month || mDay < day || mhour < hour || mMinu < minute) {
    ...
    private void createCard(boolean update) {
       ...
       if (StringUtils.isEquals( userInfo.getUser_type(), "1") && StringUtils.isEmpty(for_userid)) {
            ...
            if (StringUtils.isEmpty(mtime)) {
                UIUtils.showToast(MainPlusMorningActivity.this, "请选择叫早时间");
                dismissDialog();
                return;
            }
                    ...
                    try {
                        if (StringUtils.isNotEmpty(t.toString())) {
                            ...
                            if (status == Constants.STATUS_SUCCESS) {
                                ...
                                Toast.makeText(MainPlusMorningActivity.this, getString(R.string.param_missing), Toast.LENGTH_SHORT).show();
                            } else if (status == Constants.STATUS_PARAM_ILLEGA) { // 参数值非法
                                Toast.makeText(MainPlusMorningActivity.this, getString(R.string.param_illegal), Toast.LENGTH_SHORT).show();
                            } else if (status == Constants.STATUS_OTHER_ERROR) { // 999其他错误
                                Toast.makeText(MainPlusMorningActivity.this, msg, Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(MainPlusMorningActivity.this, getString(R.string.servers_error), Toast.LENGTH_SHORT).show();
                            }
                        }
    ...
    protected void onResume() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                tv_beizu_content.setText(Constants.CARD_ADD_MORNING_CONTENT);
            }
        });
        super.onResume();
    }
                    ...
                    if (StringUtils.isNotEmpty(t.toString())) {
                        ...
                        if (status == Constants.STATUS_SUCCESS) { // 正确
                            if(StringUtils.isNotEmpty(data)){
                                ...
                                TipPopWindow addPopWindow = new TipPopWindow(MainPlusMorningActivity.this,appHelpData,action);  
