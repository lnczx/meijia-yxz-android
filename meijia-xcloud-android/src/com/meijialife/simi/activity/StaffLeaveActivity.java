...
import com.meijialife.simi.adapter.StaffLeaveAdapter;
...
public class StaffLeaveActivity extends Activity implements OnClickListener {
    ...
    private void initStaffView() {
        ...
        adapter = new StaffLeaveAdapter(this);
        ...
        mPullRefreshListView.setOnRefreshListener(new OnRefreshListener2<ListView>() {
            ...
            public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
                ...
                if (myFriendList != null && myFriendList.size() >= 10) {
                    ...
                    Toast.makeText(StaffLeaveActivity.this, "请稍后，没有更多加载数据", Toast.LENGTH_SHORT).show();
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Friend friend1 = totalFriendList.get(position);
                    if (StringUtils.isEquals(userInfo.getUser_id(), tv_id.getText().toString())) {
                        UIUtils.showToast(StaffLeaveActivity.this, "审批人不能选择自己！");
                        return;
                    }
                    ContactBean contactBean = new ContactBean(friend1.getMobile(), friend1.getName(), friend1.getFriend_id());
                    if (cb.isChecked()) {
                        cb.setChecked(false);
                        SpFileUtil.saveBoolean(StaffLeaveActivity.this, SpFileUtil.KEY_CHECKED_STAFFS, friend1.getFriend_id(), false);
                        Constants.finalContacBeantMap.remove(friend1.getFriend_id());
                    } else {
                        cb.setChecked(true);
                        SpFileUtil.saveBoolean(StaffLeaveActivity.this, SpFileUtil.KEY_CHECKED_STAFFS, friend1.getFriend_id(), true);
                        Constants.finalContacBeantMap.put(friend1.getFriend_id(), contactBean);
                    }
                adapter.notifyDataSetChanged();
            }
        });
    ...
    private void getMyRqCode() {
        ...
        new FinalHttp().get(Constants.URL_GET_COMPANY_DETAIL, param, new AjaxCallBack<Object>() {
            ...
            public void onFailure(Throwable t, int errorNo, String strMsg) {
                ...
                dismissDialog();
                Toast.makeText(StaffLeaveActivity.this, getString(R.string.network_failure), Toast.LENGTH_SHORT).show();
            }
            ...
            public void onSuccess(Object t) {
                ...
                if (!StringUtils.isEmpty(errorMsg.trim())) {
                    UIUtils.showToast(StaffLeaveActivity.this, errorMsg);
                }
            }
        });
    }
