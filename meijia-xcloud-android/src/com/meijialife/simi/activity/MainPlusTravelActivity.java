...
public class MainPlusTravelActivity extends BaseActivity implements OnClickListener, ItemScroListener {
    ...
    private void createTrevel() {
        ...
        showDialog();
        final String c_id = DBHelper.getUser(MainPlusTravelActivity.this).getId();
        String date = tv_date.getText().toString();
        String time = tv_chufa_time.getText().toString();
                            ...
                            if (list != null && list.size() > 0) {
                                for (Iterator iterator = list.iterator(); iterator.hasNext();) {
                                    ...
                                    if (StringUtils.isEquals(contactBean.getUser_id(), c_id)
                                        ...
                                        AlermUtils.initAlerm(MainPlusTravelActivity.this, remindAlerm, date, "差旅规划", card.getService_content(),
                                                card.getCard_id());
