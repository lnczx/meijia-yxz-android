...
public class DefaultDownloadHelper extends SQLiteOpenHelper {
  ...
  private static final String SQL_CREATE_DOWNLOAD_TABLE = String.format(
      "CREATE TABLE %s (_id integer PRIMARY KEY NOT NULL,supportRanges integer NOT NULL,createAt long NOT NULL,uri varchar(255) NOT NULL,path varchar(255) NOT NULL,size long NOT NULL, progress long NOT NULL,status integer NOT NULL,videoId varchar(255) NOT NULL,videoTitle varchar(255) NOT NULL,videoImageUrl varchar(255));",
