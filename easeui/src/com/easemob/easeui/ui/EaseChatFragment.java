...
public class EaseChatFragment extends EaseBaseFragment implements EMEventListener {
    ...
    protected SimiUser simiUser;	//add by garry ，用来在标题显示对方昵称（来自消息列表）
    protected String nickName;//add by garry ，用来在标题显示对方昵称（来自好友信息页面）
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        simiUser = DBHelper.getInstance(getActivity()).getSimiUserInfo(getActivity(), toChatUsername);
