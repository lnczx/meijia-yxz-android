...
public class AssetTypeAdapter extends BaseAdapter {
    ...
    private List<XcompanySetting> typeDatas;
    private FinalBitmap finalBitmap;
    private BitmapDrawable defDrawable;
    private Context context;

	public AssetTypeAdapter(Context context) {
		inflater = LayoutInflater.from(context);
		typeDatas = new ArrayList<XcompanySetting>();
	...
	public void setData(List<XcompanySetting> typeList) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		XcompanySetting type = typeDatas.get(position);
