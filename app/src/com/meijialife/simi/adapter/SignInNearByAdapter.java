 ...
 * 
 */
public class SignInNearByAdapter extends BaseAdapter implements Filterable {
	private ArrayFilter mFilter;
	private ArrayList<PoiInfo> mList;
	private Context context;
	private ArrayList<PoiInfo> mUnfilteredData;
	
	public SignInNearByAdapter(Context context) {
		mList = new ArrayList<>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ViewHolder holder;
		if(convertView==null){
			view = View.inflate(context, R.layout.sign_in_nearby_item, null);
