 ...
 * @author Andy
 * @since 2015-05-12
 *     <p>Thanks for https://github.com/keithellis/MaterialWidget
 */
public class IndicatorTabBar extends HorizontalScrollView {
  ...
  /**
   * the ViewPager used with the IndicatorTabBar, not necessary, you could use the IndicatorTabBar
   * individually
   */
  ...
  public IndicatorTabBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    mTextSize =
        attributes.getDimensionPixelSize(
            R.styleable.IndicatorTabBar_tab_text_size,
            getResources().getDimensionPixelSize(R.dimen.tab_text_size));

    mTextColor =
        attributes.getColor(
            R.styleable.IndicatorTabBar_tab_text_color,
    ...
    mUnderLineColor =
        attributes.getColor(
            R.styleable.IndicatorTabBar_tab_underline_color,
            getResources().getColor(R.color.simi_color_red));
    mUnderLineHeight =
        attributes.getDimensionPixelSize(
            R.styleable.IndicatorTabBar_tab_underline_height,
            getResources().getDimensionPixelSize(R.dimen.tab_underline_height));

    mMaxColumn =
        attributes.getInteger(
            R.styleable.IndicatorTabBar_tab_max_column,
  ...
  public void initViewForVideo(List<VideoChannel> channels) {
        ...
        new OnTabSelectedListener() {
          ...
          public void onTabSelected(TabView tabView, boolean isRefresh) {
            ...
            if (index == 0) { // 精选
              ...
              String userTags =
                  SpFileUtil.getString(context, SpFileUtil.KEY_USER_TAGS, Constants.USER_TAGS, "");
