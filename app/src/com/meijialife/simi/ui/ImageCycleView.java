...
public class ImageCycleView extends LinearLayout {
	...
	private TextView tv_ad_des;//广告标题
	private LinearLayout ll_beizhu;//广告标题控件
	/**
	 * 图片轮播指示器控件
	 */
	 ...
	 */
	public void setImageResources(ArrayList<FindBean> infoList, ImageCycleViewListener imageCycleViewListener) {
		// 清除所有子视图
	...
	private class ImageCycleAdapter extends PagerAdapter {
		 ...
		 * 图片资源列表
		 */
		private ArrayList<FindBean> mAdList = new ArrayList<FindBean>();
		...
		public ImageCycleAdapter(Context context, ArrayList<FindBean> adList, ImageCycleViewListener imageCycleViewListener) {
			mContext = context;
			mAdList = adList;
		...
		public Object instantiateItem(ViewGroup container, final int position) {
		    FindBean findBean =  mAdList.get(position);
			String imageUrl =findBean.getImg_url();
	...
	public static interface ImageCycleViewListener {
		 ...
		 * @param imageView
		 */
		public void onImageClick(FindBean info, int postion, View imageView);
	}
