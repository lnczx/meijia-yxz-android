...
//			mContainer = (LinearLayout) getChildAt(0);
	...
	public void initDatas(HorizontalScrollViewAdapter mAdapter)
	{
		...
		if (mChildWidth == 0 && mChildHeight == 0)
		{
			...
			mChildWidth = (mScreenWitdh-5)/3;
			mChildHeight = (mScreenWitdh-5)/3;
		...
		//初始化第一屏幕的元素
		initFirstScreenChildren(mCountOneScreen,mChildWidth);
	}
	 ...
	 */
	public void initFirstScreenChildren(int mCountOneScreen,int viewHeight)
	{
		mContainer = (LinearLayout) getChildAt(0);
		...
		for (int i = 0; i < mCountOneScreen; i++)
		{
			...
			view.setMinimumWidth(viewHeight);
			view.setOnClickListener(this);
			mContainer.addView(view);
			mViewPos.put(view, i);
			mCurrentIndex = i;
