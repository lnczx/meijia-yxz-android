...
public class HaveInfoFragment extends BaseFragment {
  ...
  public View onCreateView(
    ...
    v = inflater.inflate(R.layout.layout_find_view, null);
    vs = getActivity().getLayoutInflater().inflate(R.layout.personal_fragment, null);
    findViewById(v);
    init(v);
    setListener();
    return v;
  ...
  private void setOnClick() {
    gv_application1.setOnItemClickListener(
  ...
  private void setListener() {
    rg_nav_content.setOnCheckedChangeListener(
    ...
    mPullRefreshListView.setOnItemClickListener(
        new OnItemClickListener() {
          ...
          public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            routeUtil.Routing(
                findBean.getGoto_type(),
                findBean.getAction(),
                findBean.getGoto_url(),
                findBean.getService_type_ids(),
                findBean.getTitle());
            postAddHit(findBean.getId());
          }
        });

    rl_total_search.setOnClickListener(
        new OnClickListener() {
          @Override
      ...
      if (i == 0) {
        ...
        mImageView.setLayoutParams(
            new LinearLayout.LayoutParams(
                itemWidth + radio.getPaddingLeft() + radio.getPaddingRight(), 4));
      }
          ...
          public void onCheckedChanged(RadioGroup group, int checkedId) {
            ...
            for (Iterator iterator = buttonList.iterator(); iterator.hasNext(); ) {
              ...
              if (checkedId == buttonId) {
                ...
                translateAnimation =
                    new TranslateAnimation(mCurrentCheckedRadioLeft, rb.getLeft(), 0f, 0f);
                ...
                mHorizontalScrollView.smoothScrollTo(
                    ...
                    0);
                mImageView.setLayoutParams(
                    new LinearLayout.LayoutParams(rb.getRight() - rb.getLeft(), 4));
                getFind2List(chanelBean.getChannel_id(), page);
              } else {
  ...
  public HaveInfoFragment() {
    super();
  }

  public HaveInfoFragment(MainActivity activity) {
    super();
        ...
        .get(
            ...
            new AjaxCallBack<Object>() {
              ...
              public void onFailure(Throwable t, int errorNo, String strMsg) {
                ...
                dismissDialog();
                Toast.makeText(activity, getString(R.string.network_failure), Toast.LENGTH_SHORT)
                    .show();
              }
                  ...
                  if (StringUtils.isNotEmpty(t.toString())) {
                    ...
                    if (status == Constants.STATUS_SUCCESS) { // 正确
                      if (StringUtils.isNotEmpty(data)) {
                        Gson gson = new Gson();
                        myFindBeanList =
                            gson.fromJson(data, new TypeToken<ArrayList<FindBean>>() {}.getType());
                  ...
                  if (StringUtils.isNotEmpty(t.toString())) {
                    ...
                    if (status == Constants.STATUS_SUCCESS) { // 正确
                      if (StringUtils.isNotEmpty(data)) {
                        ...
                        chanelBeanList =
                            gson.fromJson(
                                data, new TypeToken<ArrayList<ChanelBean>>() {}.getType());
                      } else {
                        chanelBeanList = new ArrayList<ChanelBean>();
                      }
