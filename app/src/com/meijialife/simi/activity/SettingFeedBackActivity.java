...
public class SettingFeedBackActivity extends BaseActivity {
    ...
    private final String TAG = SettingFeedBackActivity.class.getName();
    ...
    private void initView() {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.custom_fb_dev_reply, null);
        TextView replyContent = (TextView) view.findViewById(R.id.fb_reply_content);
        replyContent.setText(getResources().getString(R.string.setting_feedback_welcome));
