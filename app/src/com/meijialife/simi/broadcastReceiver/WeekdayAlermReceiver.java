...
public class WeekdayAlermReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        List<AlertCardData> alertList = AssetsDatabaseManager.searchAlertCardByPeriod(db,"2");
        ...
        for (Iterator iterator = alertList.iterator(); iterator.hasNext();) {
            ...
            Log.d("tag", "每工作日提醒--- "+flag);
            Log.d("tag", "每个工作日提醒CurrentStr--- " + currentLong);
            Log.d("tag", "每个工作日提醒serviceStr " + serviceLong);

            if(flag && CalendarUtils.isWeekdayByToday()){
                ...
                Log.i("tag", "weekDayAlerm---"+alertCardData.getAlert_id());
