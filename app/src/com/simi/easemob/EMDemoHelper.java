...
import com.simi.easemob.domain.RobotUser;
import com.simi.easemob.parse.UserProfileManager;
import com.simi.easemob.receiver.CallReceiver;
import com.simi.easemob.ui.ChatActivity;
import com.simi.easemob.ui.EMMainActivity;
import com.simi.easemob.ui.VideoCallActivity;
import com.simi.easemob.ui.VoiceCallActivity;
...
public class EMDemoHelper {
	...
	private EMDemoModel demoModel = null;
	...
	public synchronized static EMDemoHelper getInstance() {
		if (instance == null) {
	...
	public void init(Context context) {
		if (EaseUI.getInstance().init(context)) {
		    ...
		    EMChat.getInstance().setDebugMode(false); //modify by garry
		    //get easeui instance
		    easeUI = EaseUI.getInstance();
		    //调用easeui的api设置providers
		    setEaseUIProviders();
		    demoModel = new EMDemoModel(context);
		    //设置chat options
		    setChatoptions();
            ...
            public void onConnected() {
                ...
                if(isGroupsSyncedWithServer && isContactsSyncedWithServer){
                    new Thread(){
                        @Override
                        public void run(){
                            EMDemoHelper.getInstance().notifyForRecevingEvents();
                        }
                    }.start();
                }else{
    ...
    class MyGroupChangeListener implements EMGroupChangeListener {
        ...
        public void onInvitationReceived(String groupId, String groupName, String inviter, String reason) {
            ...
            //发送local广播
            broadcastManager.sendBroadcast(new Intent(EMConstant.ACTION_GROUP_CHANAGED));
        }
    ...
    protected void onConnectionConflict(){
        Intent intent = new Intent(appContext, EMMainActivity.class);
